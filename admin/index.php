...
<?php if (file_exists('../rw_common/plugins/stacks/total-cms/interim.check')) setcookie("total-interim",true,time()+10); ?>


<?php header('pwa-no-cache: true'); ?><!doctype html>
<html class="no-js no-touch"  lang="de">
<head>
    <meta charset="utf-8" />
	<title>Admin - Pharecon</title>
...
<link rel="icon" type="image/x-icon" href="https://www.pharecon.de/resources/favicon.ico" sizes="16x16" />
	...
	<meta name="twitter:title" content="Admin - Pharecon">
	...
	<meta name="twitter:url" content="https://www.pharecon.de/admin/index.php">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="Personalberatung Direktansprache von Fach- und Führungskräften">
	<meta property="og:title" content="Admin - Pharecon">
	...
	<meta property="og:url" content="https://www.pharecon.de/admin/index.php">
...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		...
		<meta class="stacks4 stack version" id="com.joeworkman.stacks.totalcms.admin.blog.list" name="Blog List" content="1.10.22">
...
<head>
	...
	<link rel="stylesheet" href="files/stacks_in_1346_pagesafe.css?rwcache=689175030" />
</head>
<body class="color linear  ">

<section id="pagesafe-wrapper" class="">

	<form id="pagesafe" class="input-password icon-keyhole digits4" method="post" action="files/stacks_in_1346_pagesafe.php" data-action="files/stacks_in_1346_pagesafe.php">
...
<footer id="pagesafe-footer">
	...
	<script src="files/stacks_in_1346_pagesafe.js?rwcache=689175030"></script>
<?php
...
<div id="feed-edit" class="reveal reveal-modal" data-reveal>
	<h4>Edit Post</h4>
	<form autocomplete="off" id="form_feed_stacks_in_1321" class="total-form feed-form feed-edit-form" method="post" action="../rw_common/plugins/stacks/total-cms/totalapi.php">
...
<div id="feed-edit-hipwig" class="reveal reveal-modal" data-reveal>
	<h4>Edit Post</h4>
	<form autocomplete="off" id="form_feed_hipwig_stacks_in_1321" class="total-form feed-form feed-edit-form" method="post" action="../rw_common/plugins/stacks/total-cms/totalapi.php">
...
<div class="chroma-mark">  <div class= "chroma-marker" data-chroma-style="fix_now" id="stacks_in_1146_63"></div> </div> 
 ...
 class='s-pro sections-stack      top-margin-none bot-margin-none    sec-overflow   no-vault-z  ' ><div class="shear-wrapper preload-wrapper  " id="sections_stacks_in_69"><div class='shear-inner   style-pro-stacks_in_69    ovl-style-pro-stacks_in_69   fixed-height     '><div class="inner-content autoPad  "><div class='content-wrapper  '><div class="content "> <div id='stacks_out_1341' class='stacks_out stacks_l_hidden stacks_s_hidden'><div id='stacks_in_1341' class='stacks_in com_bigwhiteduck_stacks_sections_pro_fixed_element_stack'><div class="section-fix pre-load"> <div id='stacks_out_1343' class='stacks_out stacks_l_hidden stacks_s_hidden'><div id='stacks_in_1343' class='stacks_in com_joeworkman_stacks_fluidimage_stack'><div class="fluid-image define_max align-center">  
<div class='centered_image' >
    <a href="../" title="Startseite - Pharecon"><img class='imageStyle' src='files/pharecon-logo-weissenhorn-1.png' alt='Admin-Bereich von Pharecon, Personalberatung in D-A-CH, die Experten im Sektor Life Science mit über 20 Jahren Erfahrung.' /></a>
</div>

  </div> 
</div></div></div> <div class="spacer_stacks_in_1341"></div> <div class='slice empty out'><div class='slice empty in'></div></div>

</div></div></div></div></div></div></div> <div class='sections-layer  '>  
 </div>  </section>

</div></div>  </div>  </div> 
<div        class='container   overflow-hidden   '>  <div class="grid-container">  <div class='grid-x            padding-columns  '> <div class="cell small-12 medium-auto "> <div id='stacks_out_1324' class='stacks_out'><div id='stacks_in_1324' class='stacks_in com_marathia_stacks_smart2columns2_stack'><!-- Start of Smart2columns2 Stack v2.4.2 -->

<div class="s2c_stacks_in_1324_cw"><!--
	--><div class="s2c_stacks_in_1324_col1"><div id='stacks_out_27' class='stacks_out'><div id='stacks_in_27' class='stacks_in com_bigwhiteduck_stacks_headerpro_stack'>    
...
<h2 class="header-pro text-inherit   alt    " >
			...
			<span class="h-pro"><!--
--><!--
--><span class="hTxt primary  ">Blog Stellenanzeigen</span><!--
--><!--
--><!--
--><!--
--></span>
...
<div class='slice empty out'><div class='slice empty in'></div></div>
	...
	--><div class="s2c_stacks_in_1324_spacer"></div><!--
	--><div class="s2c_stacks_in_1324_col2">  <a href="../admin/admin-stellenanzeigen/" role="button" target="_self" class="button    large hollow         expanded  "          >Neuer Beitrag</a>    
</div><!--
--></div>
<!-- End of Smart2columns2 Stack --></div></div><div id='stacks_out_1325' class='stacks_out'><div id='stacks_in_1325' class='stacks_in com_joeworkman_stacks_totalcms_admin_blog_list_stack'> <form class="blog-filter" autocomplete="off"> <div class="right total"><span class="count">0</span> Posts</div> <select name="scope"> <option value="all" selected>All Fields</option> <option value="author">Author</option> <option value="genre">Genre</option> <option value="category">Category</option> <option value="tag">Tag</option> <option value="label">Label</option> <option value="title">Title</option> </select> <input type="text" spellcheck="true" placeholder="Filter" name="filter" /> </form>  <ul style="min-height:450px" class="admin total-blog-list " data-maxheight="450" data-slug="totalcms" data-editurl="../admin/admin-stellenanzeigen/" data-dateformat='DD-MM-YYYY' data-filter='{"all":true,"sort":"","date":"DD-MM-YYYY","draft":"top","featured":"top","archived":"hide"}'>  </ul> 
...
<a href="../kontakt/" title="Kontakt - Pharecon">Kontakt</a><br /><a href="../impressum/" title="Impressum - Pharecon">Impressum</a><br /><a href="../datenschutz/" title="Datenschutz - Pharecon">Datenschutz</a><br /><a href="./" title="Admin - Pharecon">Admin</a>
