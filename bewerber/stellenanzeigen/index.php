...
<link rel="icon" type="image/x-icon" href="https://www.pharecon.de/resources/favicon.ico" sizes="16x16" />
	...
	<meta name="twitter:url" content="https://www.pharecon.de/bewerber/stellenanzeigen/index.php">
	...
	<meta property="og:url" content="https://www.pharecon.de/bewerber/stellenanzeigen/index.php">
...
<link rel="stylesheet" type="text/css" media="all" href="../../rw_common/plugins/stacks/wysiwyg-content.css?rwcache=689176327" /><link rel="stylesheet" type="text/css" media="all" href="../../rw_common/plugins/stacks/animate3.min.css?rwcache=689176327" />		<link rel='stylesheet' type='text/css' media='all' href='files/stacks_page_page10.css?rwcache=689176327' />
...
<script type="text/javascript" charset="utf-8" src="../../rw_common/plugins/stacks/wow.min.js?rwcache=689176327"></script><script type="text/javascript" charset="utf-8" src="../../rw_common/plugins/stacks/moment-with-locales.min.js?rwcache=689176327"></script>		  <link rel="stylesheet" href="../../rw_common/plugins/stacks/utility.css?rwcache=689176327" /> 

		<script type='text/javascript' charset='utf-8' src='files/stacks_page_page10.js?rwcache=689176327'></script>
		...
		<meta class="stacks4 stack version" id="com.joeworkman.stacks.totalcms.blog.genre" name="Genre" content="1.10.22">
		...
		<meta class="stacks4 stack version" id="com.joeworkman.stacks.totalcms.blog.content" name="Content" content="1.10.22">
		...
		<meta class="stacks4 stack version" id="com.joeworkman.stacks.totalcms.blog.title" name="Title" content="1.10.22">
		...
		<meta class="stacks4 stack version" id="com.joeworkman.stacks.totalcms.blog.post" name="Blog Post" content="1.10.22">
		...
		<meta class="stacks4 stack version" id="ws.foundation.animate" name="Animate In v6.9.9" content="6.11.7">
		...
		<meta class="stacks4 stack version" id="com.joeworkman.stacks.totalcms.blog.extracontent" name="Extra Content" content="1.10.22">
...
<div        class='container   overflow-hidden   '>  <div class="grid-container">  <div class='grid-x            padding-columns  '> <div class="cell small-12 medium-auto ">    <div class="animate on-hover " style=" --animation-name     : pulse; --animation-duration : 800ms; --animation-delay    : 0ms; --animation-count    : 1;">   <div class="svg full-width stacks_in_1391 text-left   mb:16"> <a href="../../bewerber/" title="FÜR KANDIDATEN"> <svg id="ff20ba94-8a2b-447b-af7c-b14c9066e6de" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256,0C114.833,0,0,114.833,0,256S114.833,512,256,512,512,397.167,512,256,397.167,0,256,0Zm0,490.667C126.604,490.667,21.333,385.396,21.333,256S126.604,21.333,256,21.333,490.667,126.604,490.667,256,385.396,490.667,256,490.667Z"/><path d="M306.208,131.125a10.66178,10.66178,0,0,0-15.083,0L173.792,248.458a10.66175,10.66175,0,0,0,0,15.083L291.125,380.874a10.66564,10.66564,0,1,0,15.084-15.083L196.417,256,306.209,146.208A10.66271,10.66271,0,0,0,306.208,131.125Z"/></svg> </a> </div> 
  </div>  
...
if ($where === "url" && isset($_GET["permalink"]) && !isset($blogpost)) {
	$totalblog->set_permalink($_GET["permalink"]);
	$blogpost = $totalblog->get_contents();

	
}
if ($where === "dynamic" || ($noposts === "dynamic" && $blogpost === false)) {
	$filter = array("sort"=>"new","date"=>"past","featured"=>"top","draft"=>"hide","archived"=>"hide");
	...
	$totalblog->set_permalink($post->permalink);
	$blogpost = $totalblog->get_contents();
}
...
if (isset($blogpost) && is_object($blogpost)) {
	...
	$totalob = preg_replace("/<title>.*<\/title>/", "<title>$blogpost->title</title>", $totalob);
	...
	echo str_replace("</"."head>",$meta."</"."head>",$totalob);
?>
...
<h1 class="post-title  text-left   "><?php echo $blogpost->title; ?> </h1>
...
<div class="post-genre-wrapper stacks_in_1333 align-left">
	
	
	<p class="post-genre     "><?php echo $blogpost->genre; ?></p>
...
<div id='stacks_out_1334' class='stacks_out'><div id='stacks_in_1334' class='stacks_in horizontal-line_stack'><div class='myLine' style='display:block; height:auto; border-top-style:solid; border-top-color:#76B82A; border-top-width:1px; font-size:1%;'></div></div></div><div id='stacks_out_1322' class='stacks_out'><div id='stacks_in_1322' class='stacks_in com_marathia_stacks_smart2columns2_stack'><!-- Start of Smart2columns2 Stack v2.4.2 -->

<div class="s2c_stacks_in_1322_cw"><!--
	--><div class="s2c_stacks_in_1322_col1">
...
<?php
	...
	$content = $totalblog->oembed($content);
...
?>
	...
	--><div class="s2c_stacks_in_1322_spacer"></div><!--
	--><div class="s2c_stacks_in_1322_col2">
<div class="post-extra  fr-view text-left   ">
<?php
	
	$content = $blogpost->extra;
...
--></div>
<!-- End of Smart2columns2 Stack --></div></div><div id='stacks_out_1371' class='stacks_out'><div id='stacks_in_1371' class='stacks_in com_joeworkman_stacks_jack4_stack'><div class="jack  align-center width-fill            bg-transparent bg-size-auto bg-repeat      corner-shadow-right corner-shadow-left     "
 data-width="16" data-height='9'>   <a href=" mailto:info@pharecon.de?subject=Stellenanzeige%20auf%20www.pharecon.de " role="button" target="_self" class="button    large         secondary expanded mb:0 "          >Jetzt bewerben!</a>    
</div>
...
<?php
// if isset($blogpost) && is_object($blogpost) check
}
if (!isset($blogpost) || $blogpost === false) {
...
<div id='stacks_out_1347' class='stacks_out'><div id='stacks_in_1347' class='stacks_in '><div        class='container   overflow-hidden hintergrund-gruen  '>  <div class="grid-container">  <div class='grid-x            padding-columns  '> <div class="cell small-12 medium-auto "> <div id='stacks_out_1347_11' class='stacks_out'><div id='stacks_in_1347_11' class='stacks_in com_bigwhiteduck_stacks_sections_pro_section_stack'><section 

 class='s-pro sections-stack      top-margin-none bot-margin-none    sec-overflow   no-vault-z  ' ><div class="shear-wrapper preload-wrapper  " id="sections_stacks_in_1347_11"><div class='shear-inner   style-pro-stacks_in_1347_11    ovl-style-pro-stacks_in_1347_11     '><div class="inner-content autoPad  "><div class='content-wrapper  '><div class="content "> <div id='stacks_out_1347_9' class='stacks_out'><div id='stacks_in_1347_9' class='stacks_in com_bigwhiteduck_stacks_sections_pro_fixed_element_stack'><div class="section-fix pre-load"> <div id='stacks_out_1347_7' class='stacks_out'><div id='stacks_in_1347_7' class='stacks_in com_marathia_stacks_smart3columns2_stack'><!-- Start of Smart3columns2 Stack v2.4.2 -->

<div class="s3c_stacks_in_1347_7_cw"><!--
	--><div class="s3c_stacks_in_1347_7_col1"><div class='grid-x    grid-margin-x grid-margin-y  grid-padding-y     padding-columns-r  '> <div class="cell small-12 medium-auto "> <div id='stacks_out_1347_3' class='stacks_out'><div id='stacks_in_1347_3' class='stacks_in com_bigwhiteduck_stacks_paragraphpro_stack'>
...
</div></div><div id='stacks_out_1347_18' class='stacks_out'><div id='stacks_in_1347_18' class='stacks_in com_bigwhiteduck_stacks_headerpro_stack'>    
...
</div></div><div id='stacks_out_1347_25' class='stacks_out'><div id='stacks_in_1347_25' class='stacks_in com_bigwhiteduck_stacks_paragraphpro_stack'>
...
</div></div><div id='stacks_out_1347_28' class='stacks_out'><div id='stacks_in_1347_28' class='stacks_in com_bigwhiteduck_stacks_paragraphpro_stack'>
...
<div class='slice empty out'><div class='slice empty in'></div></div>
	...
	--><div class="s3c_stacks_in_1347_7_spacer"></div><!--
	--><div class="s3c_stacks_in_1347_7_col2"><div id='stacks_out_1347_32' class='stacks_out stacks_m_hidden stacks_s_hidden'><div id='stacks_in_1347_32' class='stacks_in Vertical_line_stack'><div class='vert1' style='display:block; border-left-style:solid; border-left-color:#FFFFFF; border-left-width:1px; padding-left:10px;'><div id='stacks_out_1347_30' class='stacks_out'><div id='stacks_in_1347_30' class='stacks_in spacer_stack'><div class="stacksSpacer" style="display:block; width:100%; height:580px;"></div></div></div></div></div></div></div><!--
	--><div class="s3c_stacks_in_1347_7_spacer"></div><!--
	--><div class="s3c_stacks_in_1347_7_col3"><div class='grid-x   align-center grid-margin-x grid-margin-y  grid-padding-y     margin-left padding-columns-l  '> <div class="cell small-12 medium-auto large-auto"> <form id="stacks_in_1347_37" data-stack="stacks_in_1347_37" class="ajax-form  position-relative " autocomplete="on" autocapitalize="none" enctype="application/x-www-form-urlencoded"  data-abide novalidate> <div id='stacks_out_1347_35' class='stacks_out'><div id='stacks_in_1347_35' class='stacks_in com_bigwhiteduck_stacks_paragraphpro_stack'>
...
</div></div><div id='stacks_out_1347_43' class='stacks_out'><div id='stacks_in_1347_43' class='stacks_in com_bigwhiteduck_stacks_headerpro_stack'>    
...
</div></div><div id='stacks_out_1347_50' class='stacks_out'><div id='stacks_in_1347_50' class='stacks_in com_bigwhiteduck_stacks_paragraphpro_stack'>
...
<div        class='container position-relative  overflow-hidden   '>  <div class="grid-container full">  <div class='grid-x     grid-margin-y         '> <div class="cell small-12 medium-auto "> <div id='stacks_out_1347_53' class='stacks_out'><div id='stacks_in_1347_53' class='stacks_in com_bigwhiteduck_stacks_paragraphpro_stack'>
...
</div></div><div id='stacks_out_1347_60' class='stacks_out'><div id='stacks_in_1347_60' class='stacks_in com_bigwhiteduck_stacks_paragraphpro_stack'>
...
<div class="form-submit-processing processing-modal " > <div class="processing-circle spin-cw infinite bounce-out slow  alert  "></div> </div> 
 ...
 <div class="form-submit-error callout alert " aria-live="assertive" role="alert"> <p>Leider ist ein Problem aufgetreten. Sie können uns direkt kontaktieren über <a href="mailto:info@pharecon.de">info@pharecon.de</a></p> </div>  
   <div id="f6-action-stacks_in_1347_72" data-action="email" class="hide" aria-hidden="true"></div> <input type="hidden" name="formkey-stacks_in_1347_72" value="stacks_in_1347_37" data-abide-ignore aria-hidden="true"/> 
 </form> 
 </div> </div> 
</div><!--
--></div>
<!-- End of Smart3columns2 Stack --></div></div></div> <div class="spacer_stacks_in_1347_9"></div> <div class='slice empty out'><div class='slice empty in'></div></div>
...
<?php
	if (isset($blogpost) && $blogpost !== false) {
	    ...
	    ob_start();
		$totalreplace = new \TotalCMS\ReplaceText();
		echo $totalreplace->blog_replace($blogpost,$totalob);
	}
?>
