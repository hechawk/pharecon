...
stacks.stacks_in_1172 = {};
stacks.stacks_in_1172 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;

return stack;})(stacks.stacks_in_1172);
stacks.stacks_in_1400 = {};
stacks.stacks_in_1400 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;

return stack;})(stacks.stacks_in_1400);
stacks.stacks_in_1457 = {};
stacks.stacks_in_1457 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;// Start dooFaq2 stack each Javascript code// iconate framework!function(){"use strict";function a(a,b,c){a.style.setProperty("-webkit-animation",b+" "+c+"s"),a.style.setProperty("animation",b+" "+c+"s"),a.style.setProperty("-moz-animation",b+" "+c+"s"),a.style.setProperty("-o-animation",b+" "+c+"s")}function b(a){a.style.removeProperty("-webkit-animation"),a.style.removeProperty("animation"),a.style.removeProperty("-moz-animation"),a.style.removeProperty("-o-animation")}function c(a,b,c){a.classList.contains(b)&&a.classList.remove(b),a.classList.add(c)}function d(d,l,m){function n(){var a=k(),b=p/2;q=window.setTimeout(function(){var e=k()-a;e>=b&&c(d,l.from,l.to)},b)}function o(){window.clearTimeout(q),b(d),d.removeEventListener(f,o),d.removeEventListener(e,n),"function"==typeof m&&m()}if(!d)throw new Error('Iconate > "element" is required');if(!j)return c(d,l.from,l.to),void("function"==typeof m&&m());l=l||{};var p,q,r;r=l.animation||i,p=l.duration||g,d.addEventListener(e,n,!1),d.addEventListener(f,o,!1),a(d,r,p/h)}var e,f,g=600,h=1e3,i="zoomOut",j=function(){var a=document.documentElement.style;return void 0!==a.animation||void 0!==a.webkitAnimation}();f=void 0===window.onanimationend&&void 0!==window.onwebkitanimationend?"webkitAnimationEnd":"animationend",e=void 0===window.onanimationstart&&void 0!==window.onwebkitanimationstart?"webkitAnimationStart":"animationstart";var k=Date.now||function(){return(new Date).getTime()};"object"==typeof exports?module.exports=d:"function"==typeof define&&define.amd?define(function(){return d}):window.iconate=d}();// faq code$(document).ready(function() {		// animate the icon	function stacks_in_1457animate(element,iconFrom,iconTo,animationType) {		stacks_in_1457IsAnimating = true;	    iconate(element, {	        from: iconFrom,	        to: iconTo,	        animation: animationType	    }, function() {		    	        stacks_in_1457callback();	    });	}		// toggle animation done	var stacks_in_1457callback = function() {		stacks_in_1457IsAnimating = false;	}		// add an icon to each if required	$("#stacks_in_1457 .faq-question").each(function(){		$(this).find("i").addClass('fa-bars');	});					// declare open vars	var stacks_in_1457IsAnimating = false;	switch("fa-bars") {	    case "fa-toggle-off":	        var stacks_in_1457iconOpenClass = "fa-toggle-on";			var stacks_in_1457iconClosedClass = "fa-toggle-off";			var stacks_in_1457iconAnimation = "bounceOutRight";			var stacks_in_1457iconCloseAnimation = "bounceOutLeft";	        break;	    case "fa-question":	        var stacks_in_1457iconOpenClass = "fa-times";			var stacks_in_1457iconClosedClass = "fa-question";			var stacks_in_1457iconAnimation = "tada";			var stacks_in_1457iconCloseAnimation = "rubberBand";	        break;	    case "fa-angle-right":	        var stacks_in_1457iconOpenClass = "fa-angle-down";			var stacks_in_1457iconClosedClass = "fa-angle-right";			var stacks_in_1457iconAnimation = "bounceOutBottom";			var stacks_in_1457iconCloseAnimation = "fadeOutLeft";	        break;	    case "fa-bars":	        var stacks_in_1457iconOpenClass = "fa-times";			var stacks_in_1457iconClosedClass = "fa-bars";			var stacks_in_1457iconAnimation = "tada";			var stacks_in_1457iconCloseAnimation = "rubberBand";	        break;	    default:	        var stacks_in_1457iconOpenClass = "fa-toggle-on";			var stacks_in_1457iconClosedClass = "fa-toggle-off";			var stacks_in_1457iconAnimation = "bounceOutRight";			var stacks_in_1457iconCloseAnimation = "bounceOutLeft";	}				// animation handlers	function stacks_in_1457open_faq_section(sectionQuestion) {		if("yes" == "yes"){			stacks_in_1457close_other_open_faq_section(sectionQuestion)		}		$(sectionQuestion).siblings(".faq-answer").slideDown(300,"swing");		iconElementId = $("i", sectionQuestion).attr("id");		var iconElement = document.getElementById(iconElementId);		stacks_in_1457animate(iconElement,stacks_in_1457iconClosedClass,stacks_in_1457iconOpenClass,stacks_in_1457iconAnimation);        $(sectionQuestion).removeClass("faqQuestionClosed").addClass("faqQuestionOpen");    }    function stacks_in_1457close_faq_section(sectionQuestion) {	    $(sectionQuestion).siblings(".faq-answer").slideUp(300,"swing");	    iconElementId = $("i", sectionQuestion).attr("id");		var iconElement = document.getElementById(iconElementId);		stacks_in_1457animate(iconElement,stacks_in_1457iconOpenClass,stacks_in_1457iconClosedClass,stacks_in_1457iconCloseAnimation);        $(sectionQuestion).removeClass("faqQuestionOpen").addClass("faqQuestionClosed");    }    function stacks_in_1457close_other_open_faq_section(sectionQuestion) {	    if($("#stacks_in_1457 .faqQuestionOpen").length){		    $("#stacks_in_1457 .faqQuestionOpen").siblings(".faq-answer").slideUp(300,"swing");			var iconElementId = $("#stacks_in_1457 .faqQuestionOpen i").attr("id");			var iconElement = document.getElementById(iconElementId);			stacks_in_1457animate(iconElement,stacks_in_1457iconOpenClass,stacks_in_1457iconClosedClass,stacks_in_1457iconCloseAnimation);		    $("#stacks_in_1457 .faqQuestionOpen").removeClass("faqQuestionOpen").addClass("faqQuestionClosed");	    }    }	// on clicking a question	$('#stacks_in_1457 .faq-question').on("click", function(e){		e.preventDefault();		if (stacks_in_1457IsAnimating) return;				if($(this).hasClass("faqQuestionOpen")){			stacks_in_1457close_faq_section($(this));		}else{			stacks_in_1457open_faq_section($(this));		}	});		// strat with first item open or not	if("no" == "yes"){		var stacks_in_1457firstItem = $("#stacks_in_1457 .faq-question").get(0);		stacks_in_1457open_faq_section($(stacks_in_1457firstItem));	}}); // end doc ready// End dooFaq2 stack each Javascript code
return stack;})(stacks.stacks_in_1457);
stacks.stacks_in_1356 = {};
stacks.stacks_in_1356 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;

return stack;})(stacks.stacks_in_1356);
stacks.stacks_in_1621 = {};
stacks.stacks_in_1621 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;// Start dooFaq2 stack each Javascript code// iconate framework!function(){"use strict";function a(a,b,c){a.style.setProperty("-webkit-animation",b+" "+c+"s"),a.style.setProperty("animation",b+" "+c+"s"),a.style.setProperty("-moz-animation",b+" "+c+"s"),a.style.setProperty("-o-animation",b+" "+c+"s")}function b(a){a.style.removeProperty("-webkit-animation"),a.style.removeProperty("animation"),a.style.removeProperty("-moz-animation"),a.style.removeProperty("-o-animation")}function c(a,b,c){a.classList.contains(b)&&a.classList.remove(b),a.classList.add(c)}function d(d,l,m){function n(){var a=k(),b=p/2;q=window.setTimeout(function(){var e=k()-a;e>=b&&c(d,l.from,l.to)},b)}function o(){window.clearTimeout(q),b(d),d.removeEventListener(f,o),d.removeEventListener(e,n),"function"==typeof m&&m()}if(!d)throw new Error('Iconate > "element" is required');if(!j)return c(d,l.from,l.to),void("function"==typeof m&&m());l=l||{};var p,q,r;r=l.animation||i,p=l.duration||g,d.addEventListener(e,n,!1),d.addEventListener(f,o,!1),a(d,r,p/h)}var e,f,g=600,h=1e3,i="zoomOut",j=function(){var a=document.documentElement.style;return void 0!==a.animation||void 0!==a.webkitAnimation}();f=void 0===window.onanimationend&&void 0!==window.onwebkitanimationend?"webkitAnimationEnd":"animationend",e=void 0===window.onanimationstart&&void 0!==window.onwebkitanimationstart?"webkitAnimationStart":"animationstart";var k=Date.now||function(){return(new Date).getTime()};"object"==typeof exports?module.exports=d:"function"==typeof define&&define.amd?define(function(){return d}):window.iconate=d}();// faq code$(document).ready(function() {		// animate the icon	function stacks_in_1621animate(element,iconFrom,iconTo,animationType) {		stacks_in_1621IsAnimating = true;	    iconate(element, {	        from: iconFrom,	        to: iconTo,	        animation: animationType	    }, function() {		    	        stacks_in_1621callback();	    });	}		// toggle animation done	var stacks_in_1621callback = function() {		stacks_in_1621IsAnimating = false;	}		// add an icon to each if required	$("#stacks_in_1621 .faq-question").each(function(){		$(this).find("i").addClass('fa-bars');	});					// declare open vars	var stacks_in_1621IsAnimating = false;	switch("fa-bars") {	    case "fa-toggle-off":	        var stacks_in_1621iconOpenClass = "fa-toggle-on";			var stacks_in_1621iconClosedClass = "fa-toggle-off";			var stacks_in_1621iconAnimation = "bounceOutRight";			var stacks_in_1621iconCloseAnimation = "bounceOutLeft";	        break;	    case "fa-question":	        var stacks_in_1621iconOpenClass = "fa-times";			var stacks_in_1621iconClosedClass = "fa-question";			var stacks_in_1621iconAnimation = "tada";			var stacks_in_1621iconCloseAnimation = "rubberBand";	        break;	    case "fa-angle-right":	        var stacks_in_1621iconOpenClass = "fa-angle-down";			var stacks_in_1621iconClosedClass = "fa-angle-right";			var stacks_in_1621iconAnimation = "bounceOutBottom";			var stacks_in_1621iconCloseAnimation = "fadeOutLeft";	        break;	    case "fa-bars":	        var stacks_in_1621iconOpenClass = "fa-times";			var stacks_in_1621iconClosedClass = "fa-bars";			var stacks_in_1621iconAnimation = "tada";			var stacks_in_1621iconCloseAnimation = "rubberBand";	        break;	    default:	        var stacks_in_1621iconOpenClass = "fa-toggle-on";			var stacks_in_1621iconClosedClass = "fa-toggle-off";			var stacks_in_1621iconAnimation = "bounceOutRight";			var stacks_in_1621iconCloseAnimation = "bounceOutLeft";	}				// animation handlers	function stacks_in_1621open_faq_section(sectionQuestion) {		if("yes" == "yes"){			stacks_in_1621close_other_open_faq_section(sectionQuestion)		}		$(sectionQuestion).siblings(".faq-answer").slideDown(300,"swing");		iconElementId = $("i", sectionQuestion).attr("id");		var iconElement = document.getElementById(iconElementId);		stacks_in_1621animate(iconElement,stacks_in_1621iconClosedClass,stacks_in_1621iconOpenClass,stacks_in_1621iconAnimation);        $(sectionQuestion).removeClass("faqQuestionClosed").addClass("faqQuestionOpen");    }    function stacks_in_1621close_faq_section(sectionQuestion) {	    $(sectionQuestion).siblings(".faq-answer").slideUp(300,"swing");	    iconElementId = $("i", sectionQuestion).attr("id");		var iconElement = document.getElementById(iconElementId);		stacks_in_1621animate(iconElement,stacks_in_1621iconOpenClass,stacks_in_1621iconClosedClass,stacks_in_1621iconCloseAnimation);        $(sectionQuestion).removeClass("faqQuestionOpen").addClass("faqQuestionClosed");    }    function stacks_in_1621close_other_open_faq_section(sectionQuestion) {	    if($("#stacks_in_1621 .faqQuestionOpen").length){		    $("#stacks_in_1621 .faqQuestionOpen").siblings(".faq-answer").slideUp(300,"swing");			var iconElementId = $("#stacks_in_1621 .faqQuestionOpen i").attr("id");			var iconElement = document.getElementById(iconElementId);			stacks_in_1621animate(iconElement,stacks_in_1621iconOpenClass,stacks_in_1621iconClosedClass,stacks_in_1621iconCloseAnimation);		    $("#stacks_in_1621 .faqQuestionOpen").removeClass("faqQuestionOpen").addClass("faqQuestionClosed");	    }    }	// on clicking a question	$('#stacks_in_1621 .faq-question').on("click", function(e){		e.preventDefault();		if (stacks_in_1621IsAnimating) return;				if($(this).hasClass("faqQuestionOpen")){			stacks_in_1621close_faq_section($(this));		}else{			stacks_in_1621open_faq_section($(this));		}	});		// strat with first item open or not	if("no" == "yes"){		var stacks_in_1621firstItem = $("#stacks_in_1621 .faq-question").get(0);		stacks_in_1621open_faq_section($(stacks_in_1621firstItem));	}}); // end doc ready// End dooFaq2 stack each Javascript code
return stack;})(stacks.stacks_in_1621);
stacks.stacks_in_1649 = {};
stacks.stacks_in_1649 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;// Start dooFaq2 stack each Javascript code// iconate framework!function(){"use strict";function a(a,b,c){a.style.setProperty("-webkit-animation",b+" "+c+"s"),a.style.setProperty("animation",b+" "+c+"s"),a.style.setProperty("-moz-animation",b+" "+c+"s"),a.style.setProperty("-o-animation",b+" "+c+"s")}function b(a){a.style.removeProperty("-webkit-animation"),a.style.removeProperty("animation"),a.style.removeProperty("-moz-animation"),a.style.removeProperty("-o-animation")}function c(a,b,c){a.classList.contains(b)&&a.classList.remove(b),a.classList.add(c)}function d(d,l,m){function n(){var a=k(),b=p/2;q=window.setTimeout(function(){var e=k()-a;e>=b&&c(d,l.from,l.to)},b)}function o(){window.clearTimeout(q),b(d),d.removeEventListener(f,o),d.removeEventListener(e,n),"function"==typeof m&&m()}if(!d)throw new Error('Iconate > "element" is required');if(!j)return c(d,l.from,l.to),void("function"==typeof m&&m());l=l||{};var p,q,r;r=l.animation||i,p=l.duration||g,d.addEventListener(e,n,!1),d.addEventListener(f,o,!1),a(d,r,p/h)}var e,f,g=600,h=1e3,i="zoomOut",j=function(){var a=document.documentElement.style;return void 0!==a.animation||void 0!==a.webkitAnimation}();f=void 0===window.onanimationend&&void 0!==window.onwebkitanimationend?"webkitAnimationEnd":"animationend",e=void 0===window.onanimationstart&&void 0!==window.onwebkitanimationstart?"webkitAnimationStart":"animationstart";var k=Date.now||function(){return(new Date).getTime()};"object"==typeof exports?module.exports=d:"function"==typeof define&&define.amd?define(function(){return d}):window.iconate=d}();// faq code$(document).ready(function() {		// animate the icon	function stacks_in_1649animate(element,iconFrom,iconTo,animationType) {		stacks_in_1649IsAnimating = true;	    iconate(element, {	        from: iconFrom,	        to: iconTo,	        animation: animationType	    }, function() {		    	        stacks_in_1649callback();	    });	}		// toggle animation done	var stacks_in_1649callback = function() {		stacks_in_1649IsAnimating = false;	}		// add an icon to each if required	$("#stacks_in_1649 .faq-question").each(function(){		$(this).find("i").addClass('fa-bars');	});					// declare open vars	var stacks_in_1649IsAnimating = false;	switch("fa-bars") {	    case "fa-toggle-off":	        var stacks_in_1649iconOpenClass = "fa-toggle-on";			var stacks_in_1649iconClosedClass = "fa-toggle-off";			var stacks_in_1649iconAnimation = "bounceOutRight";			var stacks_in_1649iconCloseAnimation = "bounceOutLeft";	        break;	    case "fa-question":	        var stacks_in_1649iconOpenClass = "fa-times";			var stacks_in_1649iconClosedClass = "fa-question";			var stacks_in_1649iconAnimation = "tada";			var stacks_in_1649iconCloseAnimation = "rubberBand";	        break;	    case "fa-angle-right":	        var stacks_in_1649iconOpenClass = "fa-angle-down";			var stacks_in_1649iconClosedClass = "fa-angle-right";			var stacks_in_1649iconAnimation = "bounceOutBottom";			var stacks_in_1649iconCloseAnimation = "fadeOutLeft";	        break;	    case "fa-bars":	        var stacks_in_1649iconOpenClass = "fa-times";			var stacks_in_1649iconClosedClass = "fa-bars";			var stacks_in_1649iconAnimation = "tada";			var stacks_in_1649iconCloseAnimation = "rubberBand";	        break;	    default:	        var stacks_in_1649iconOpenClass = "fa-toggle-on";			var stacks_in_1649iconClosedClass = "fa-toggle-off";			var stacks_in_1649iconAnimation = "bounceOutRight";			var stacks_in_1649iconCloseAnimation = "bounceOutLeft";	}				// animation handlers	function stacks_in_1649open_faq_section(sectionQuestion) {		if("yes" == "yes"){			stacks_in_1649close_other_open_faq_section(sectionQuestion)		}		$(sectionQuestion).siblings(".faq-answer").slideDown(300,"swing");		iconElementId = $("i", sectionQuestion).attr("id");		var iconElement = document.getElementById(iconElementId);		stacks_in_1649animate(iconElement,stacks_in_1649iconClosedClass,stacks_in_1649iconOpenClass,stacks_in_1649iconAnimation);        $(sectionQuestion).removeClass("faqQuestionClosed").addClass("faqQuestionOpen");    }    function stacks_in_1649close_faq_section(sectionQuestion) {	    $(sectionQuestion).siblings(".faq-answer").slideUp(300,"swing");	    iconElementId = $("i", sectionQuestion).attr("id");		var iconElement = document.getElementById(iconElementId);		stacks_in_1649animate(iconElement,stacks_in_1649iconOpenClass,stacks_in_1649iconClosedClass,stacks_in_1649iconCloseAnimation);        $(sectionQuestion).removeClass("faqQuestionOpen").addClass("faqQuestionClosed");    }    function stacks_in_1649close_other_open_faq_section(sectionQuestion) {	    if($("#stacks_in_1649 .faqQuestionOpen").length){		    $("#stacks_in_1649 .faqQuestionOpen").siblings(".faq-answer").slideUp(300,"swing");			var iconElementId = $("#stacks_in_1649 .faqQuestionOpen i").attr("id");			var iconElement = document.getElementById(iconElementId);			stacks_in_1649animate(iconElement,stacks_in_1649iconOpenClass,stacks_in_1649iconClosedClass,stacks_in_1649iconCloseAnimation);		    $("#stacks_in_1649 .faqQuestionOpen").removeClass("faqQuestionOpen").addClass("faqQuestionClosed");	    }    }	// on clicking a question	$('#stacks_in_1649 .faq-question').on("click", function(e){		e.preventDefault();		if (stacks_in_1649IsAnimating) return;				if($(this).hasClass("faqQuestionOpen")){			stacks_in_1649close_faq_section($(this));		}else{			stacks_in_1649open_faq_section($(this));		}	});		// strat with first item open or not	if("no" == "yes"){		var stacks_in_1649firstItem = $("#stacks_in_1649 .faq-question").get(0);		stacks_in_1649open_faq_section($(stacks_in_1649firstItem));	}}); // end doc ready// End dooFaq2 stack each Javascript code
return stack;})(stacks.stacks_in_1649);
stacks.stacks_in_1676_11 = {};
stacks.stacks_in_1676_11 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;
$(function(){$(window).on('load',function(){$('#stacks_in_1676_11>.s-pro:not(.vault-height)>.shear-wrapper').removeClass('preload-wrapper');$('#stacks_in_1676_11>.s-pro:not(.vault-height) .content').removeClass('preload-content');});});

return stack;})(stacks.stacks_in_1676_11);
stacks.stacks_in_1676_9 = {};
stacks.stacks_in_1676_9 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;
$(function(){var win=$(window),stack=$('#stacks_in_1676_9'),spacer=$('.spacer_stacks_in_1676_9'),positionClass='section-bottom',sideClass='section-full-width',sectionWrapperId='#'+stack.closest('.shear-wrapper').attr('id'),sectionContent=stack.closest('.content-wrapper');stack.unwrap();stack.addClass('section-absolute').addClass(positionClass).addClass(sideClass).addClass('').appendTo(sectionWrapperId);if(positionClass=='section-bottom'){spacer.appendTo(sectionContent);}else{spacer.prependTo(sectionContent);}var resizeSpacer=function(){var targetHeight=stack.outerHeight();spacer.css('height',targetHeight);}
win.on("resize",resizeSpacer);resizeSpacer();$(window).load(function(){$('.section-fix',stack).removeClass('pre-load');resizeSpacer();});});

return stack;})(stacks.stacks_in_1676_9);
stacks.stacks_in_1676_37 = {};
stacks.stacks_in_1676_37 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery; const form=$("#stacks_in_1676_37");if(form.hasClass("auto-submit-on-select-change")){$("select",form).change(()=>form.submit());}
